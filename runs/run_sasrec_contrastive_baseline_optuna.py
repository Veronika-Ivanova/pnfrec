...
def objective(trial):
    ...
    with mlflow.start_run(run_name="ml1m_sasrec_contrastive_baseline"):
        ...
        model = SASRecContrastiveBaseline(
            item_num=item_count,
            add_head=add_head,
            maxlen=MAX_LENGTH,
            num_heads=1,
        ...
        seqrec_module = SeqRecContrastiveBaseline(model, lr=lr, predict_top_k=10, filter_seen=True, 
